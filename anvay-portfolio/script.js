...
(function(){
  ...
  const CALLOUTS = [
    { pt: [0.48, 0.12], text: "SYS.SENSORY // PARIETAL", align: "left", ox: 35, oy: -15 },
    { pt: [0.64, 0.18], text: "SYS.LOGIC // FRONTAL", align: "left", ox: 30, oy: -15 },
    { pt: [0.82, 0.35], text: "SYS.PERCEPTION", align: "left", ox: 25, oy: 0 },
    { pt: [0.28, 0.26], text: "SYS.VISION // OCCIPITAL", align: "right", ox: -30, oy: -10 },
    { pt: [0.37, 0.72], text: "SYS.TRANSMISSION // SPINE", align: "right", ox: -30, oy: 0 },
    { pt: [0.40, 0.40], text: "SYS.MOTOR // CEREBELLUM", align: "right", ox: -35, oy: 15 }
  ];

  // Internal circuit nodes redistributed to sit inside head/neck structure
  const NODES = [
    [0.48, 0.26], [0.44, 0.38], [0.28, 0.36], [0.44, 0.48], [0.40, 0.56],
    [0.37, 0.68], [0.28, 0.82], [0.64, 0.44], [0.60, 0.28], [0.36, 0.22]
  ];
  const EDGES = [
